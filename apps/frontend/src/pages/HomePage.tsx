...
const HomePage = () => {
  ...
  const handleCreatePoll = () => {
    if (isAuthenticated) {
      // User is already authenticated, redirect to host dashboard
      navigate('/host');
    } else {
      // User not authenticated, go to login with redirect
  ...
  const handleJoinPoll = () => {
    if (isAuthenticated) {
      // User is already authenticated, redirect to student dashboard
      navigate('/student');
    } else {
      // User not authenticated, go to login with redirect
